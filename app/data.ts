...
export const courses = [
  ...
  { name: "健康舞", en: "AEROBIC DANCE", image: "/images/group-linedance.png", short: "簡單易跟，街坊同樂", description: "一班人跟住熟悉節奏做簡單帶氧動作，循序提升心肺體能。氣氛輕鬆，讓不同年齡的街坊一齊郁、一齊笑。", audience: "初學者及銀齡住戶", badge: "銀齡同樂" },
