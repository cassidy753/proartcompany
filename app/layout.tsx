...
export const metadata: Metadata = {
  metadataBase: new URL(
    process.env.GITHUB_PAGES === "true"
      ? "https://cassidy753.github.io/proartcompany/"
      : "https://pro-art-company-hk.brks4p8t6v.chatgpt.site",
  ),
  title: "Pro Art Company｜香港會所健身課程專業夥伴",
  description: "為香港私人屋苑會所策劃及承辦瑜伽、普拉提、健康舞、Zumba 及排舞課程。由規劃、導師到行政，一站式妥善處理。",
  icons: {
    icon: process.env.GITHUB_PAGES === "true" ? "/proartcompany/favicon.svg" : "/favicon.svg",
    shortcut: process.env.GITHUB_PAGES === "true" ? "/proartcompany/favicon.svg" : "/favicon.svg",
  },
