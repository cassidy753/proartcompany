...
export default function PartnershipPage() {
  return <main>
    ...
    <section className="process" aria-labelledby="process-title"><h2 id="process-title">由想法到開班，四步完成</h2><ol><li><strong>洽談</strong><p>了解住戶與場地需要</p></li><li><strong>規劃</strong><p>設計課程、時段及收費</p></li><li><strong>開班</strong><p>配對導師並處理行政</p></li><li><strong>結算</strong><p>每月提供清晰帳單</p></li></ol></section>
